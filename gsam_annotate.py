...
# Model
grounding_dino_model, sam_predictor, box_annotator, mask_annotator, label_annotator = initialize(input_dir=input_dir, out_dir=out_dir, logfile=logfile, use_sam_hq=False)
